...
public class AnyMemoCentralDBOpenHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        Log.v(TAG, "Creating central database");
    ...
    /**
     * Do not call this method directly, use AnyMemoCentralDBOpenHelperManager instead.
     */
    @Override
    public void close() {
        isReleased = true;
    ...
    public void finalize() throws Throwable {
        ...
        if (!isReleased) {
            Log.w(TAG, "AnyMemoCentralDBOpenHelper for db " + dbPath + " is not released before being GCed. This class must be explicitly released! Force releasing now.");
            AnyMemoCentralDBOpenHelperManager.forceRelease(dbPath);
        }
    }

    /* Package private constructor used in Manager. */
    AnyMemoCentralDBOpenHelper(Context context, String dbpath) {
