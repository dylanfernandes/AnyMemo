...
public class AllTagsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        previousDeck = bundle.getString("previousDeck");
        ...
        String dbName = "central.db";
        AnyMemoBaseDBOpenHelper centralDBHelper = AnyMemoBaseDBOpenHelperManager.getHelper(dbName);
        tagDao = centralDBHelper.getTagDao();
    ...
    public void onDestroyView() {
        ((TagsActivity) getActivity()).getSupportActionBar().setSubtitle(previousDeck);
        super.onDestroyView();
    }
